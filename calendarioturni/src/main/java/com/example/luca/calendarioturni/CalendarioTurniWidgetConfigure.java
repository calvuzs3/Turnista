package com.example.luca.calendarioturni;
...
import com.example.luca.calendarioturni.dialogs.CalendarPickerDialog;
import com.example.luca.calendarioturni.dialogs.ColorPickerDialog;
import com.example.luca.calendarioturni.utilities.CalendarUtilities;
import com.example.luca.calendarioturni.utilities.Constants;
import com.example.luca.calendarioturni.utilities.datamodels.PackageInfoWrapper;
import com.example.luca.calendarioturni.utilities.datamodels.PackageListAdapter;
 ...
 * @author brianreber
 */
public class CalendarioTurniWidgetConfigure extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chooseCalendarsButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                final CalendarPickerDialog dlg = new CalendarPickerDialog(CalendarioTurniWidgetConfigure.this, util);
                try {
                ...
                dlg.setOnDismissListener(new OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        ...
                        CalendarioTurniWidgetProvider.saveUtil(util);
                    }
                });
                dlg.show();
            }
        ...
        textColorButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dlg = new ColorPickerDialog(CalendarioTurniWidgetConfigure.this, ocl, textColor);
                dlg.show();
            }
        });
        ...
        bgColorButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dlg = new ColorPickerDialog(CalendarioTurniWidgetConfigure.this, ocl, bgColor);
                dlg.show();
            }
        });
    ...
    private void initializeUIElementVars() {
        ...
        textSizes.add(getResources().getString(R.string.word_large));
        textSizes.add(getResources().getString(R.string.word_medium));
        textSizes.add(getResources().getString(R.string.word_small));
        ...
        public void onClick(View arg0) {
            ...
            if (str != null && !str.equals("")) {
                try {
                    ...
                    Toast.makeText(CalendarioTurniWidgetConfigure.this, getResources().getString(R.string.str_invalidNumberOfDays), Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            ...
            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(CalendarioTurniWidgetConfigure.this);
            CalendarioTurniWidgetProvider.updateAppWidget(CalendarioTurniWidgetConfigure.this, appWidgetManager, mAppWidgetId, 0);

            CalendarioTurniWidgetProvider.saveUtil(util);

            Intent widgetUpdate = new Intent();
            widgetUpdate.setAction(CalendarioTurniWidgetProvider.WIDGET_UPDATE);
    ...
    public static void setAlarm(Context ctx, int mAppWidgetId) {
        ...
        CalendarioTurniWidgetProvider.addIdToAlarm(ctx, mAppWidgetId);
    }
    ...
    public static void cancelAlarm(Context ctx, int mAppWidgetId) {
        ...
        CalendarioTurniWidgetProvider.removeIdFromList(ctx, mAppWidgetId);
    }
}