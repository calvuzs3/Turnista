...
import com.example.luca.calendarioturni.utilities.AndroidCalendar;
...
import com.example.luca.calendarioturni.utilities.datamodels.Event;
 ...
 * @author brianreber
 */
public class CalendarioTurniWidgetProvider extends AppWidgetProvider {

    public static String WIDGET_NEXT_EVENT = "com.example.luca.calendarioturni.AGENDA_WIDGET_NEXT_EVENT";
    public static String WIDGET_UPDATE = "com.example.luca.calendarioturni.AGENDA_WIDGET_UPDATE";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            if (!ids.contains(Integer.valueOf(appWidgetId))) {
                CalendarioTurniWidgetConfigure.setAlarm(context, appWidgetId);
            }
        }
    }
    ...
    public static void updateAppWidget(final Context context, AppWidgetManager appWidgetManager, final int appWidgetId, int eventPos) {
        ...
        /*if (packageName.equals("com.example.luca.calendarioturni")) {
            intent = new Intent(context, CalendarioTurniActivity.class);
            intent.putExtra(CalendarioTurniActivity.WIDGET_EXTRA, appWidgetId);
            ...
            //			intent = new Intent(context, CalendarioTurniWidgetConfigure.class);
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.calendarioturniwidget);
        ...
        if (events == null || events.isEmpty()) {
            ...
            if (location == null || location.equals("")) {
                ...
                views.setTextViewText(R.id.when_no_loc,  (!tomorrow.contains(context.getResources().getText(R.string.word_today)) ? tomorrow + " ": "") +
                ...
                views.setTextViewText(R.id.when,  (!tomorrow.contains(context.getResources().getText(R.string.word_today)) ? tomorrow + " ": "") +
                        util.getFormattedTimeString(context, first));
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            CalendarioTurniWidgetConfigure.cancelAlarm(context, appWidgetId);
        }
    }
