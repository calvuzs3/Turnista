package com.example.luca.calendarioturni.dialogs;
...
public class CalendarPickerDialog extends Dialog {
    ...
    public CalendarPickerDialog(Context context, CalendarUtilities util) {
        ...
        cals = new HashSet<AndroidCalendar>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.calendars_listview);
        ...
        Button b = (Button) findViewById(R.id.calendars_save_selected_calendars);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cals = new HashSet<AndroidCalendar>();

                Set<AndroidCalendar> events = util.getAvailableCalendars();
